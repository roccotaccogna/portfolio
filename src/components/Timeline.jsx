        ...
        >
            {data.map((item, index) => (
                ...
                >
                    ...
                    >
                        <div 
                            className="absolute flex items-center justify-center w-10 
                                       h-10 rounded-full -left-[15px] bg-midnight"
                        >
                            <div 
                        ...
                        <div 
                            className="flex-col hidden gap-2 text-xl font-bold md:flex 
            ...
            >
                <motion.div
                    ...
                    className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-teal-500 
                             via-teal-700 to-transparent from-[0%] via-[10%] rounded-full"
                />
            </div>
        </div>
    </div>
